// Author: https://github.com/miketimmerman/load-template
var LoadTemplate = function(element, template, data){
    // Check if parent element is defined as string or object.
    ...
    this.folderPath = '../casa-rara.github.io/templates/';
};
